...
*/
      ...
      db.transaction(function(tx){
        ...
        function (tx, result){
          ...
          btnInsetar.style.display='block';
          btnenlistar.style.display='block';
          btnborrar.style.display='block';
          btnborrarTable.style.display='block';
          btnlocationbtn.style.display='block';
        },
          function (error) {
            alert(error);
        });
